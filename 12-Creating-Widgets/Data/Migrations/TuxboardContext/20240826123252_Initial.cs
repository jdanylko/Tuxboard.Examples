    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WidgetRole", x => new { x.WidgetId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_WidgetRole_TuxboardRole_RoleId",
                        column: x => x.RoleId,
                        principalSchema: "dbo",
                        principalTable: "TuxboardRole",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WidgetRole_Widget_WidgetId",
                        column: x => x.WidgetId,
                        principalSchema: "dbo",
                        principalTable: "Widget",
                        principalColumn: "WidgetId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("31c3df95-fdc6-4fb5-82ab-0436ea93c1b1"), "e776afa8-cd36-47eb-b066-ae6469468b1e", "Basic", "BASIC" },
                    { new Guid("7e69eb1f-07c0-46a1-b4e8-86f56386c250"), "8d58fe18-6ac9-4886-b0f5-276b52b411e1", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("d804e116-e80b-49c1-9c30-0ea989d88aad"), 1, new Guid("1623f469-d9f0-400c-8a4c-b4366233f485"), new Guid("62487409-221b-40ff-a62b-fc3046b97ccb"), new Guid("ee84443b-7ee7-4754-bb3c-313cc0da6039"), 1 }
                });
