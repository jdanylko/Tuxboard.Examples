import { collapsedToggleSelector, dataId, defaultGeneralOverlaySelector, defaultLoadingSelector, defaultWidgetBodySelector, defaultWidgetSelector, hideElement, isStaticAttribute, showElement } from "../common";
...
export class WidgetPlacement {
    constructor(parent, placementId = "", index = 0, columnIndex = 0) {
        ...
        this.getSelectorWithPlacementId = (placementId) => `[${dataId}='${placementId}']`;
        this.getSelector = () => `${this.selector}[${dataId}='${this.placementId}']`;
        ...
        this.isStatic = () => this.getDom().getAttribute(isStaticAttribute) === "true";
        ...
        this.getProperties = () => new WidgetProperties(this.placementId, this.columnIndex, this.index, this.parent.getAttribute(dataId));
    }
}
