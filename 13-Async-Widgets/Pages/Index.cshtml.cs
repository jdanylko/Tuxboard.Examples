...
using AsyncWidgets.Extensions;
using AsyncWidgets.Identity;
using AsyncWidgets.Models;
using AsyncWidgets.Pages.Shared.Components.AddWidgetDialog;
using AsyncWidgets.Pages.Shared.Components.AdvancedLayoutDialog;
...
public class IndexModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostGetWidgetAsync([FromBody] WidgetRequest request)
    {
        ...
        return ViewComponent(widget.Widget.Name, new { placement = widget });
    }
    ...
    public async Task<IActionResult> OnPostAddWidgetAsync([FromBody] AddWidgetRequest request)
    {
        ...
        if (layoutRow != null && baseWidget != null)
        {
