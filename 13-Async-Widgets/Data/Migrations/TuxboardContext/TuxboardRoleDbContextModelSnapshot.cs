...
namespace AsyncWidgets.Data.Migrations.TuxboardContext
{
    ...
    partial class TuxboardRoleDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardUserLogin", b =>
                {
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardUserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardUserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AsyncWidgets.Models.RoleDefaultDashboard", b =>
                {
            ...
            modelBuilder.Entity("AsyncWidgets.Models.WidgetRole", b =>
                {
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardRoleClaim", b =>
                {
                    b.HasOne("AsyncWidgets.Identity.TuxboardRole", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("AsyncWidgets.Identity.TuxboardUserClaim", b =>
                {
                    b.HasOne("AsyncWidgets.Identity.TuxboardUser", "User")
                        .WithMany("Claims")
