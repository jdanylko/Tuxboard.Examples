...
import { dataIdAttribute, defaultColumnSelector, defaultDashboardSelector, defaultDropdownInWidgetHeaderSelector, defaultWidgetHeaderSelector, defaultWidgetStateSelector, defaultWidgetRemoveWidgetSelector, defaultWidgetSelector, getClosestByClass, getDataId, getWidgetSnapshot, isWidget, isWidgetOrColumn, noPeriod, collapsedToggleSelector, defaultWidgetBodySelector } from "./common";
...
export class Tuxboard {
    constructor() {
        ...
        this.updateWidgets = () => this.getWidgets().map((widget) => {
